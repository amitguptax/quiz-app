...
const SocialScienceQuizPage = () => {
  ...
  useEffect(() => {
    const loadQuestions = async () => {
      try {
        const filePath = `../data/socialscience/class${classId}/${subject}/${subtopic}.js`;
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "800px", margin: "auto" }}>
      <Helmet>
        <title>Social Science Quiz {classId} - {subtopic}</title>
      </Helmet>
        ...
        <>
          ...
          <ol type="1" style={{ paddingLeft: "20px", fontSize: "17px" }}>
            {question.options.map((opt, idx) => {
              const isCorrect = opt[language] === question.correct[language];
...
export default SocialScienceQuizPage;  