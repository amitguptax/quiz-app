...
import physicsTopicMap from "../data/physics/physicstopicmap"; // ✅ Make sure this file exists
import './BiologySubjectsPage.css'; // ✅ Reuse or rename if needed
...
const PhysicsQuizPage = () => {
  ...
  const folderName = physicsTopicMap[classId]?.[topic];
  ...
  useEffect(() => {
    const loadQuestions = async () => {
      try {
        const filePath = `../data/physics/class${classId}/${folderName}/${subtopic}.js`;
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "800px", margin: "auto" }}>
      <Helmet>
        <title>{`Physics Quiz - Class ${classId} - ${subtopic}`}</title>
      </Helmet>
...
export default PhysicsQuizPage;
