...
import biologytopicMap from "../data/biology/biologytopicmap";
import './BiologySubjectsPage.css';
...
const folderName = biologytopicMap[classId]?.[topic];  // ✅ Correct
 ...
 useEffect(() => {
  const loadQuestions = async () => {
    try {
      // ✅ Use the already declared folderName above
      const filePath = `../data/bio/class${classId}/${folderName}/${subtopic}.js`;
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "800px", margin: "auto" }}>
      <Helmet>
        <title>{`Biology Quiz - Class ${classId} - ${subtopic}`}</title>
      </Helmet>
